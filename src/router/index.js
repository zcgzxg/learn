...
const routes = [
  ...
  {
    path: '/Descriptions',
    name: 'AntDescriptions',
    component: () => import('../views/AntDescriptions.vue'),
  },
  {
    path: '/Empty',
    name: 'AntEmpty',
    component: () => import('../views/AntEmpty.vue'),
  },
  {
    path: '/Image',
    name: 'AntImage',
    component: () => import('../views/AntImage.vue'),
  },
  {
    path: '/List',
    name: 'AntList',
    component: () => import('../views/AntList.vue'),
  },
  {
    path: '/Pop&Statistic',
    name: 'AntPop&Statistic',
    component: () => import('../views/AntPop&Statistic.vue'),
  },
  {
    path: '/Table',
    name: 'AntTable',
